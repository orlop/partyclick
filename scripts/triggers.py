...
GPIO.add_event_detect(ArcadeBtnPin, GPIO.FALLING, callback=arcadebtn_callback, bouncetime=15000) # Watch for GPIO 17 to be grounded and call arcadebtn_callback()
