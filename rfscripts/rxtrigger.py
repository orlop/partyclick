...
GPIO.setup(17, GPIO.IN, pull_up_down=GPIO.PUD_DOWN) # GPIO BCM Pin 27 = Board Pin 11
GPIO.setup(27, GPIO.IN, pull_up_down=GPIO.PUD_UP) # GPIO BCM Pin 27 = Board Pin 13

# Threaded Callback
def rf_callback(channel):
    print("GPIO 27 triggered.")

GPIO.add_event_detect(24, GPIO.RISING, callback=rf_callback)
